...
from support_functions import indexToEliminate, plot_inliers, project_and_plot_all_image_points, is_homography_degenerate
...
while matchesMask != None:
    if len(good) >= MIN_MATCH_COUNT:
        ...
        if M is not None:
            ...
            if not is_homography_degenerate(np.linalg.inv(M), dst):
