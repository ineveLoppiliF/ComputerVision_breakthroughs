...
def pixelwise_difference_norm_check(diff_norm_image_central, MEDIAN_THRESHOLD, discarded_file, discarded_homographies):
    ...
    discarded_file.write("HOMOGRAPHY DISCARDED #"+str(discarded_homographies[0]+discarded_homographies[1]+discarded_homographies[2]+discarded_homographies[3]+discarded_homographies[4])+" (norm difference histogram median too big)\n")
