...
def fingerprint_distances_plot(fingerprint_list, template_descriptors, norm_parameters, interval, quantiles):
    ...
    plt.title("Fingerprint matches distance on Gaussian dist")
    plt.show()