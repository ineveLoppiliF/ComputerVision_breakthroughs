...
def print_discarded(discarded_homographies):
    ...
    print("----------")
    print("DISCARDED HOMOGRAPHIES UNTILL NOW (tot: "+str(discarded_homographies[0]+discarded_homographies[1]+discarded_homographies[2]+discarded_homographies[3]+discarded_homographies[4])+")")
    print("Area is too big: "+str(discarded_homographies[0]))
    print("Degenerate homography: "+str(discarded_homographies[1]))
    print("Too many points outside the polygon: "+str(discarded_homographies[2]))
